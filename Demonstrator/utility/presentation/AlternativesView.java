...
public class AlternativesView extends JPanel {
	...
	robustnessButton.addActionListener(new RobustnessButtonActionListener(
		window));
	/*
	 * robustnessButton.addActionListener(new ActionListener() { public void
	 * actionPerformed(ActionEvent e) { RobustnessView view; try { view =
	 * new RobustnessView(null,false); view.setVisible(true); } catch
