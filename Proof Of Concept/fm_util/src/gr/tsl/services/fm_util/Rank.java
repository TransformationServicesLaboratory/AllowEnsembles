        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected gr.tsl.services.fm_util.Route[] localIn ;
                           ...
                           */
                           public  gr.tsl.services.fm_util.Route[] getIn(){
                               return localIn;
                           }
                               ...
                               */
                              protected void validateIn(gr.tsl.services.fm_util.Route[] param){
                              ...
                              * @param param In
                              */
                              public void setIn(gr.tsl.services.fm_util.Route[] param){
                             ...
                             */
                             public void addIn(gr.tsl.services.fm_util.Route param){
                                   if (localIn == null){
                                   localIn = new gr.tsl.services.fm_util.Route[]{};
                                   }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"rank".equals(type)){
                                ...
                                return (Rank)gr.tsl.services.fm_util.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(gr.tsl.services.fm_util.Route.Factory.parse(reader));
                                                        ...
                                                        object.setIn((gr.tsl.services.fm_util.Route[])
