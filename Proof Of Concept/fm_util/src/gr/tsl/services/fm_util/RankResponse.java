        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected gr.tsl.services.fm_util.Route[] localOut ;
                                

                           /**
                           * Auto generated getter method
                           * @return gr.tsl.services.fm_util.Route[]
                           */
                           public  gr.tsl.services.fm_util.Route[] getOut(){
                               return localOut;
                           }
                               ...
                               */
                              protected void validateOut(gr.tsl.services.fm_util.Route[] param){
                              ...
                              * @param param Out
                              */
                              public void setOut(gr.tsl.services.fm_util.Route[] param){
                             ...
                             * @param param gr.tsl.services.fm_util.Route
                             */
                             public void addOut(gr.tsl.services.fm_util.Route param){
                                   if (localOut == null){
                                   localOut = new gr.tsl.services.fm_util.Route[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localOut);
                               list.add(param);
                               this.localOut =
                             (gr.tsl.services.fm_util.Route[])list.toArray(
                            new gr.tsl.services.fm_util.Route[list.size()]);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"rankResponse".equals(type)){
                                ...
                                return (RankResponse)gr.tsl.services.fm_util.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(gr.tsl.services.fm_util.Route.Factory.parse(reader));
                                                        ...
                                                        object.setOut((gr.tsl.services.fm_util.Route[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                gr.tsl.services.fm_util.Route.class,
                                                                list1));
