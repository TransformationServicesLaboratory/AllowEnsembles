 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                name = PRoute
                Namespace URI = http://services.tsl.gr/pssgr_util/
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.apache.axis2.databinding.types.Time[] localPTime ;
                           ...
                           */
                           public  org.apache.axis2.databinding.types.Time[] getPTime(){
                               return localPTime;
                           }
                              ...
                              /**
                               * validate the array for PTime
                               */
                              protected void validatePTime(org.apache.axis2.databinding.types.Time[] param){
                              ...
                              * @param param PTime
                              */
                              public void setPTime(org.apache.axis2.databinding.types.Time[] param){
                             ...
                             */
                             public void addPTime(org.apache.axis2.databinding.types.Time param){
                                   if (localPTime == null){
                                   localPTime = new org.apache.axis2.databinding.types.Time[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPTime);
                               list.add(param);
                               this.localPTime =
                        ...
                        */
                                    ...
                                    protected gr.tsl.services.pssgr_util.Preference[] localPrf ;
                                

                           /**
                           * Auto generated getter method
                           * @return gr.tsl.services.pssgr_util.Preference[]
                           */
                           public  gr.tsl.services.pssgr_util.Preference[] getPrf(){
                               return localPrf;
                           }
                               ...
                               */
                              protected void validatePrf(gr.tsl.services.pssgr_util.Preference[] param){
                              ...
                              * @param param Prf
                              */
                              public void setPrf(gr.tsl.services.pssgr_util.Preference[] param){
                             ...
                             /**
                             * Auto generated add method for the array for convenience
                             * @param param gr.tsl.services.pssgr_util.Preference
                             */
                             public void addPrf(gr.tsl.services.pssgr_util.Preference param){
                                   if (localPrf == null){
                                   localPrf = new gr.tsl.services.pssgr_util.Preference[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPrf);
                               list.add(param);
                               this.localPrf =
                             (gr.tsl.services.pssgr_util.Preference[])list.toArray(
                            new gr.tsl.services.pssgr_util.Preference[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://services.tsl.gr/pssgr_util/");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PRoute",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PRoute",
                           xmlWriter);
                             ...
                             if (localPTime!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localPTime.length;i++){
                                        
                                            if (localPTime[i] != null){
                                        
                                                writeStartElement(null, namespace, "pTime", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPTime[i]));
                                                    
                                                xmlWriter.writeEndElement();
                                              
                                                } else {
                                                   
                                                           throw new org.apache.axis2.databinding.ADBException("pTime cannot be null!!");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://services.tsl.gr/pssgr_util/")){
                return "ns2";
            }
                                  ...
                                  for (int i = 0;i < localPTime.length;i++){
                                         ...
                                         if (localPTime[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "pTime"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPTime[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static PRoute parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PRoute object =
                new PRoute();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PRoute".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PRoute)gr.tsl.services.pssgr_util.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","pTime").equals(reader.getName())){
                                    ...
                                    list4.add(reader.getElementText());
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","pTime").equals(reader.getName())){
                                                         list4.add(reader.getElementText());
                                            ...
                                            object.setPTime((org.apache.axis2.databinding.types.Time[])
                                    ...
                                    // Process the array and step past its final element's end.
                                    list6.add(gr.tsl.services.pssgr_util.Preference.Factory.parse(reader));
                                                        ...
                                                        object.setPrf((gr.tsl.services.pssgr_util.Preference[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                gr.tsl.services.pssgr_util.Preference.class,
                                                                list6));
